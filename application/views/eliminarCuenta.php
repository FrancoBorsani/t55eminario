...
<div class="login">
    ...
    <form action="<?php echo base_url();?>clogin/borrarDatos" method="POST">
        ...
        <button type="submit" class="btn btn-primary btn-block btn-large" name="Ingresar">Eliminar</button>
