...
header.masthead {
  ...
  background: linear-gradient(to bottom, rgba(92, 77, 66, 0.8) 0%, rgba(92, 77, 66, 0.8) 100%), url("https://i.blogs.es/5a328c/aprender-informatica/450_1000.jpg");
...
<body id="page-top">
  ...
  <section class="page-section" id="services">
    <div class="container">
                     <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
                    <h2 class="text-black mt-0">Temas:</h2>
        </div>
        </div>
